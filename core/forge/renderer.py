...
<div class="meta">{_esc(plan.context.repo)} @ {_esc(plan.context.commit_at_forge)} | Branch: {_esc(plan.context.branch)} | ArkaOS {_esc(plan.context.arkaos_version)} | Score: {plan.complexity.score}/100 ({plan.complexity.tier.value.title()})</div>
<div class="grid">
<div class="card"><h2>Complexity Radar</h2>{radar_svg}</div>
<div class="card"><h2>Critic Verdict</h2>{critic_html}</div>
</div>
{approaches_html}
<h2>Plan Phases</h2>
{phases_html}
<div class="meta" style="margin-top:2rem;text-align:center;">Generated by The Forge — ArkaOS | Read-only companion</div>
</body>
</html>"""
